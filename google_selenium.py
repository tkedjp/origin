...
# #Selenium解析
search_list = []
a_tags = driver.find_elements_by_css_selector('h3.ipQwMb')

for i, a_tag in enumerate(a_tags):
    print('='*30, i, '='*30)
    title = a_tag.find_element_by_css_selector('.DY5T1d').text
    page_url = a_tag.find_element_by_tag_name('a').get_attribute('href')
    # print(a_tag.find_element_by_css_selector('.DY5T1d').text)
